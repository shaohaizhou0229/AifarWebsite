...
function ContentTab({ section, labels, uploadingSectionId, onPatchSectionContent, onUploadImage }) {
...
export function SectionEditor({ section, labels, uploadingSectionId, onPatchSection, onPatchSectionContent, onUploadImage }) {
  ...
  return (
    <div className="builder-inspector">
      ...
      {activeTab === "content" ? (
        <ContentTab section={section} labels={labels} uploadingSectionId={uploadingSectionId} onPatchSectionContent={onPatchSectionContent} onUploadImage={onUploadImage} />
      ) : null}
