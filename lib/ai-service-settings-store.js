...
function normalizeConfig(input = {}) {
  ...
  const config = {
    ...
    AI_SECTION_TEMPLATE_TIMEOUT_MS: clean(input.AI_SECTION_TEMPLATE_TIMEOUT_MS || input.recognitionTimeoutMs || "120000", 32),
    ...
    SILICONFLOW_TIMEOUT_MS: clean(input.SILICONFLOW_TIMEOUT_MS || input.recognitionTimeoutMs || "120000", 32)
  };
...
export function buildAiSettingsEditDraft(settings = {}) {
  ...
  return {
    ...
    AI_SECTION_TEMPLATE_TIMEOUT_MS: String(recognition.timeoutMs || 120000),
    ...
    SILICONFLOW_TIMEOUT_MS: String(recognition.timeoutMs || 120000)
  };
}
