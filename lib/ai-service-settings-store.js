...
const DEFAULT_OPENAI_IMAGE_MODEL = aiServiceSettings.DEFAULT_OPENAI_IMAGE_MODEL || "gpt-image-2";
const DEFAULT_OPENAI_SECTION_TEMPLATE_MODEL = aiServiceSettings.DEFAULT_OPENAI_SECTION_TEMPLATE_MODEL || "gpt-5.5";
const CONFIG_KEYS = [
  "AI_IMAGE_PROVIDER",
  "AI_IMAGE_ENABLED",
...
function normalizeConfig(input = {}) {
  ...
  const config = {
    ...
    OPENAI_IMAGE_MODEL: clean(input.OPENAI_IMAGE_MODEL || input.openAiImageModel || DEFAULT_OPENAI_IMAGE_MODEL, 240),
    ...
    OPENAI_SECTION_TEMPLATE_MODEL: clean(input.OPENAI_SECTION_TEMPLATE_MODEL || input.openAiRecognitionModel || DEFAULT_OPENAI_SECTION_TEMPLATE_MODEL, 240),
