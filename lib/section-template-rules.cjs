...
const SECTION_VARIANTS = {
  ...
  updates_list: ["list"],
  cta_band: ["dark"],
  [AI_LAYOUT_SECTION_TYPE]: [AI_LAYOUT_VARIANT]
};
...
function normalizeTemplateSection(section) {
  ...
  return {
    ...
    content: type === AI_LAYOUT_SECTION_TYPE
      ? normalizeAiLayoutContent(isObject(section.content) ? section.content : {})
      : normalizeJsonValue(isObject(section.content) ? section.content : {}, "section.content")
  };
}
