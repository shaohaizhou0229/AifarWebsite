...
export const SITE_CONTENT_BUCKET = PROJECT_ASSET_BUCKET;
export const MAX_SITE_IMAGE_SIZE = MAX_PROJECT_ASSET_SIZE;
export const ALLOWED_SITE_IMAGE_EXTENSIONS = ALLOWED_PROJECT_ASSET_EXTENSIONS;
export const ALLOWED_SITE_IMAGE_TYPES = ALLOWED_PROJECT_ASSET_TYPES;
...
export function getSiteImageUrl(storagePath = "") {
  return getProjectAssetUrl(storagePath);
}
...
export async function isPublishedSiteImage(storagePath) {
  return isPublicProjectAssetImage(storagePath);
}
