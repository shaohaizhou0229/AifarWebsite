...
import {
  buildAiSettingsEditDraft,
  getAiServiceSettingsFromStore,
  getImageGenerationSettingsFromStore,
  getSectionTemplateRecognitionSettingsFromStore,
  saveAiServiceSettings
} from "./ai-service-settings-store";
...
export function buildOpenAIImagePayload(input = {}) {
  return imageGenerationCore.buildOpenAIImagePayload(input);
}

export function buildSiliconFlowImagePayload(input = {}) {
  return imageGenerationCore.buildSiliconFlowImagePayload(input);
}
...
export async function getAiServiceSettingsAsync(options = {}) {
  return getAiServiceSettingsFromStore(options);
}

export async function getImageGenerationSettingsAsync(options = {}) {
  return getImageGenerationSettingsFromStore(options);
}

export async function getSectionTemplateRecognitionSettingsAsync(options = {}) {
  return getSectionTemplateRecognitionSettingsFromStore(options);
}

export { buildAiSettingsEditDraft, saveAiServiceSettings };
